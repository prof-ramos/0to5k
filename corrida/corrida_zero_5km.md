# 🏃 Programa de Corrida: Zero aos 5KM
...
[![Público](https://img.shields.io/badge/público-sedentários_e_fumantes-orange.svg)](https://github.com/gabrielramos/0to5k)
...
## Integração com Treino PPL

### Progressão Máxima

- **Máximo 10% de volume de corrida por semana** para evitar lesões.

### 4 Regras Críticas

1. **Não fazer treino de pernas pesado + corrida longa no mesmo dia** (a partir da Fase 2).
2. **Domingo é descanso total** (recuperação sistêmica obrigatória).
3. **Se PSE > 7 em qualquer treino**, descansar no dia seguinte.
4. **Pernas muito cansadas após LEG** (sexta) → não correr no sábado.

### Agenda Semanal Recomendada (Fase Madura)
...
> **Nota:** Na Fase 0-1 (semanas 1-7), a corrida é caminhada/intervalos leves e pode ser feita em dias consecutivos com PPL sem problemas. As regras acima aplicam-se principalmente a partir da Fase 2.
...
- **[3] Lavie CJ, et al. (ASPC)**. _Am J Prev Cardiol 2022_. Protocolos para fumantes e riscos.
